...
export const Home = () => {
    ...
    return (
        <>
            ...
            >
                {selectedPost ? (
                    <><div className="modalfullPostInside"> 
                        <div className='postTitleInside'>{selectedPost.title}</div>
                        <div>Author: {selectedPost.author.nickname}</div>
                        {selectedPost.image && <img className='postImage' src={selectedPost.image} alt="post's image"></img>}
                            ...
                            return (
                                <div key={post._id} className='paperPost'>
                                    <div className='postDesign'>
                                        ...
                                        <div className="morePost" onClick={() => deatilPost(post)}>See more...</div>
